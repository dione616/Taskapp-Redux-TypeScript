...
//we can describe as object or func
const mapDispatch = {
  loadUserEvents,
}
const connector = connect(mapState, mapDispatch)

//describe props from redux
...
const groupEventsByDay = (events: UserEvent[]) => {
  const groups: Record<string, UserEvent[]> = {} // grouped Records
...
const Calendar: React.FC<Props> = ({ events, loadUserEvents }) => {
  ...
  if (events.length) {
    ...
    //get the key of each event and compare them
